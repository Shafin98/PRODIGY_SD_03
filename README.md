This project consist of a web application for A Simple Contact Management System to store user name, email & phone number, which I created using Electron framework. 
